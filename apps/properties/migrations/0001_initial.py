# Generated by Django 3.2.7 on 2022-06-02 21:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(default='Bangladesh', max_length=250, verbose_name='City')),
                ('postal_code', models.CharField(default='27', max_length=150, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='Bosundora 6 No', max_length=150, verbose_name='Street Address')),
                ...
                ('tax', models.DecimalField(decimal_places=2, default=0.15, help_text='15% property tax charged', max_digits=7, verbose_name='Property Tax')),
                ...
                ('bathrooms', models.DecimalField(decimal_places=2, default=1.0, max_digits=5, verbose_name='Bathrooms')),
                ...
                ('cover_photo', models.ImageField(blank=True, default='/house_sample.jpg', null=True, upload_to='', verbose_name='Main Phote')),
